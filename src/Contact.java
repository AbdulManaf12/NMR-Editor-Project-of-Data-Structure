...
public class Contact extends JFrame {
    ...
    private void _init_(){
        Image img = new ImageIcon(getClass().getClassLoader().getResource("icons/Abdul_Manaf.jpg")).getImage().getScaledInstance(160,160,10);
        ...
        add(whatsapp);
        img = new ImageIcon(getClass().getClassLoader().getResource("icons/CallIcon.png")).getImage().getScaledInstance(30,30,10);
        JLabel call = new JLabel(new ImageIcon(img));
        call.setBounds(230,390,30,30);
        add(call);
        img = new ImageIcon(getClass().getClassLoader().getResource("icons/GmailIcon.png")).getImage().getScaledInstance(30,30,10);
